...
public interface FileHandler {
     ...
     */
    StockInfo[] getStockInfoFromFile(String filePath) throws IOException;
     ...
     * @return
     */
    UserInterest[] getUserInterestFromFile(String filePath) throws IOException;

    /**
     * This function need write matrix to files
     * @param matrix the matrix you calculate
     */
    void setCloseMatrix2File(double[][] matrix) throws IOException;

    /**
     * This function need write recommend to files
     * @param recommend the recommend you calculate
     */
    void setRecommend2File(double[][] recommend) throws IOException;
